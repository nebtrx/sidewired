...
{
    public class MappingSetupServices
    {
        private static readonly Lazy<MappingSetupServices> _instance = new Lazy<MappingSetupServices>(() => new MappingSetupServices(), true);

        protected MappingSetupServices(){}

        public static MappingSetupServices GetService()
        {
            return _instance.Value;
        }

        public void ForPlayerSettings()
        {
